...
def load_config() -> Config:
    ...
    return Config(
        ...
        engagement_daily_comments=_int(os.getenv("ENGAGEMENT_DAILY_COMMENTS"), 250, minimum=0),
        engagement_daily_follows=_int(os.getenv("ENGAGEMENT_DAILY_FOLLOWS"), 400, minimum=0),
