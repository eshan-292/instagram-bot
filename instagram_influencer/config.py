...
def load_config() -> Config:
    ...
    return Config(
        ...
        engagement_daily_likes=_int(os.getenv("ENGAGEMENT_DAILY_LIKES"), 130, minimum=0),
        engagement_daily_comments=_int(os.getenv("ENGAGEMENT_DAILY_COMMENTS"), 25, minimum=0),
